// Mock data for BrightBuy Admin Dashboard
...
export const orders = [
  {
    ...
    items: [
      { productId: 1, name: "Wireless Bluetooth Headphones", quantity: 2, price: 99.99 },
      { productId: 3, name: "Organic Cotton T-Shirt", quantity: 1, price: 29.99 }
    ],
    total: 229.97,
    status: "pending",
  ...
  },
  {
    ...
    items: [
      { productId: 2, name: "Smart Fitness Watch", quantity: 1, price: 249.99 }
    ],
    total: 249.99,
    status: "processing",
    orderDate: "2024-01-16T14:15:00Z",
    shippingAddress: "456 Oak Ave, Somewhere, ST 67890",
    assignedDelivery: "DEL-002"
  },
  {
    id: "ORD-003",
    customer: {
    ...
    items: [
      { productId: 4, name: "Stainless Steel Water Bottle", quantity: 3, price: 24.99 },
      { productId: 5, name: "Gaming Mechanical Keyboard", quantity: 1, price: 129.99 }
    ],
    total: 204.96,
    status: "shipped",
    orderDate: "2024-01-15T09:45:00Z",
    shippingAddress: "789 Pine Rd, Elsewhere, ET 13579",
    assignedDelivery: "DEL-001"
  },
  {
    id: "ORD-004",
    ...
    items: [
      ...
      { productId: 3, name: "Organic Cotton T-Shirt", quantity: 2, price: 29.99 }
    ],
    total: 159.97,
    status: "delivered",
    orderDate: "2024-01-14T16:20:00Z",
    shippingAddress: "321 Elm St, Another, AT 24680",
    assignedDelivery: "DEL-003"
  }
];
...
export const users = [
  ...
  },
  {
    ...
    email: "delivery1@brightbuy.com",
    role: "delivery",
    status: "active",
    lastLogin: "2024-01-16T06:15:00Z",
    createdAt: "2023-09-10T00:00:00Z"
  },
  {
    id: 4,
    name: "Delivery Driver 2", 
    email: "delivery2@brightbuy.com",
    role: "delivery",
    status: "active",
...
export const deliveries = [
  ...
  },
  {
    ...
    driverId: 3,
    status: "delivered",
    assignedAt: "2024-01-14T17:00:00Z",
    deliveredAt: "2024-01-15T14:30:00Z",
    customerAddress: "321 Elm St, Another, AT 24680",
