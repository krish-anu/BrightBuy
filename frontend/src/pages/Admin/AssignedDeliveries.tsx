...
const AssignedDeliveries: React.FC = () => {
  ...
  const getOrderDetails = (orderId: string): Order | undefined => orders.find(order => order.id === orderId);
                ...
                {orderDetails && (
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">${orderDetails.total.toFixed(2)}</p>
                    </div>
                  </div>
                )}
              </div>
